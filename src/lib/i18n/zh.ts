...
export const zh: Translations = {
  ...
  oauth: {
    ...
    step1: '先保留首屏体验，不把评委挡在登录墙前。',
    step2: '证据卡出来后再转 OAuth，价值感更强，掉线更少。',
    step3Connected: '现在直接把证据卡同步进真人链路，验证这不只是静态内容展示。',
    step3Disconnected: '连接后立刻进入真人链路，不需要重新开始整个探索。',
    ctaConnected: '用这张证据卡继续问我的 SecondMe',
    ctaConnectedHelper: '会自动把建议问题填进真人能力区。',
    ctaDisconnected: '连接 SecondMe，计入授权登录',
    ctaDisconnectedHelper: '回来后会保留当前产品理解，你可以直接进入真人追问。',
    noOauth:
